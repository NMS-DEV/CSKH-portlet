 ...
 * @generated
 */
public abstract class CustomerInforEntryActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public CustomerInforEntryActionableDynamicQuery() throws SystemException {
		setBaseLocalService(CustomerInforEntryLocalServiceUtil.getService());
		setClass(CustomerInforEntry.class);

		setClassLoader(com.liferay.docs.customercare.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("customerInforEntryId");
	}
}