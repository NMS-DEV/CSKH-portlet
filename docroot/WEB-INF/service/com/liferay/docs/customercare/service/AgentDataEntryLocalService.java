...
/**
 * Provides the local service interface for AgentDataEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author DuyMB
 * @see AgentDataEntryLocalServiceUtil
...
public interface AgentDataEntryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AgentDataEntryLocalServiceUtil} to access the agent data entry local service. Add custom service methods to {@link com.liferay.docs.customercare.service.impl.AgentDataEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
