...
/**
 * Provides the remote service interface for CallDataEntry. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author DuyMB
 * @see CallDataEntryServiceUtil
...
public interface CallDataEntryService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CallDataEntryServiceUtil} to access the call data entry remote service. Add custom service methods to {@link com.liferay.docs.customercare.service.impl.CallDataEntryServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
