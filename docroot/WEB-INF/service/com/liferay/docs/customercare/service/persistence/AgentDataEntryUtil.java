...
/**
 * The persistence utility for the agent data entry service. This utility wraps {@link AgentDataEntryPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class AgentDataEntryUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(AgentDataEntry agentDataEntry) {
		getPersistence().clearCache(agentDataEntry);
	}
	 ...
	 */
	public static List<AgentDataEntry> findWithDynamicQuery(
	 ...
	 */
	public static AgentDataEntry update(AgentDataEntry agentDataEntry)
		throws SystemException {
		return getPersistence().update(agentDataEntry);
	}
	...
	public static AgentDataEntry update(AgentDataEntry agentDataEntry,
		...
		return getPersistence().update(agentDataEntry, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(agentDataEntry);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(agentDataEntries);
	}
	...
	*/
	public static com.liferay.docs.customercare.model.AgentDataEntry create(
		long agentDataEntryId) {
		return getPersistence().create(agentDataEntryId);
	}
	...
	*/
	public static com.liferay.docs.customercare.model.AgentDataEntry remove(
		long agentDataEntryId)
		throws com.liferay.docs.customercare.NoSuchAgentDataEntryException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(agentDataEntryId);
	}

	public static com.liferay.docs.customercare.model.AgentDataEntry updateImpl(
		com.liferay.docs.customercare.model.AgentDataEntry agentDataEntry)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(agentDataEntry);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.docs.customercare.model.AgentDataEntry findByPrimaryKey(
		long agentDataEntryId)
		throws com.liferay.docs.customercare.NoSuchAgentDataEntryException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(agentDataEntryId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.docs.customercare.model.AgentDataEntry fetchByPrimaryKey(
		long agentDataEntryId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(agentDataEntryId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.liferay.docs.customercare.model.AgentDataEntry> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static AgentDataEntryPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (AgentDataEntryPersistence)PortletBeanLocatorUtil.locate(com.liferay.docs.customercare.service.ClpSerializer.getServletContextName(),
					AgentDataEntryPersistence.class.getName());

			ReferenceRegistry.registerReference(AgentDataEntryUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(AgentDataEntryPersistence persistence) {
	}

	private static AgentDataEntryPersistence _persistence;
}