...
/**
 * The persistence utility for the customer infor entry service. This utility wraps {@link CustomerInforEntryPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class CustomerInforEntryUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(CustomerInforEntry customerInforEntry) {
		getPersistence().clearCache(customerInforEntry);
	}
	 ...
	 */
	public static List<CustomerInforEntry> findWithDynamicQuery(
	 ...
	 */
	public static CustomerInforEntry update(
		CustomerInforEntry customerInforEntry) throws SystemException {
		return getPersistence().update(customerInforEntry);
	}
	 ...
	 */
	public static CustomerInforEntry update(
		CustomerInforEntry customerInforEntry, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(customerInforEntry, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(customerInforEntry);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(customerInforEntries);
	}
	...
	*/
	public static com.liferay.docs.customercare.model.CustomerInforEntry create(
		long customerInforEntryId) {
		return getPersistence().create(customerInforEntryId);
	}
	...
	*/
	public static com.liferay.docs.customercare.model.CustomerInforEntry remove(
		long customerInforEntryId)
		throws com.liferay.docs.customercare.NoSuchCustomerInforEntryException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(customerInforEntryId);
	}

	public static com.liferay.docs.customercare.model.CustomerInforEntry updateImpl(
		com.liferay.docs.customercare.model.CustomerInforEntry customerInforEntry)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(customerInforEntry);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.docs.customercare.model.CustomerInforEntry findByPrimaryKey(
		long customerInforEntryId)
		throws com.liferay.docs.customercare.NoSuchCustomerInforEntryException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(customerInforEntryId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.liferay.docs.customercare.model.CustomerInforEntry fetchByPrimaryKey(
		long customerInforEntryId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(customerInforEntryId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.liferay.docs.customercare.model.CustomerInforEntry> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static CustomerInforEntryPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (CustomerInforEntryPersistence)PortletBeanLocatorUtil.locate(com.liferay.docs.customercare.service.ClpSerializer.getServletContextName(),
					CustomerInforEntryPersistence.class.getName());

			ReferenceRegistry.registerReference(CustomerInforEntryUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(CustomerInforEntryPersistence persistence) {
	}

	private static CustomerInforEntryPersistence _persistence;
}