 ...
 * @generated
 */
public abstract class AgentDataEntryActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public AgentDataEntryActionableDynamicQuery() throws SystemException {
		setBaseLocalService(AgentDataEntryLocalServiceUtil.getService());
		setClass(AgentDataEntry.class);

		setClassLoader(com.liferay.docs.customercare.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("agentDataEntryId");
	}
}