...
/**
 * Provides the local service interface for CustomerInforEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author DuyMB
 * @see CustomerInforEntryLocalServiceUtil
...
public interface CustomerInforEntryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CustomerInforEntryLocalServiceUtil} to access the customer infor entry local service. Add custom service methods to {@link com.liferay.docs.customercare.service.impl.CustomerInforEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
